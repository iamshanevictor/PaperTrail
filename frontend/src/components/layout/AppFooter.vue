  ...
  <footer class="bg-white border-t border-gray-200 mt-12">
    <div class="max-w-7xl mx-auto py-12 px-4 overflow-hidden sm:px-6 lg:px-8">
      <nav class="-mx-5 -my-2 flex flex-wrap justify-center" aria-label="Footer">
        <div class="px-5 py-2">
          <router-link to="/about" class="text-base text-gray-500 hover:text-gray-900">
            About
          </router-link>
        </div>
        <div class="px-5 py-2">
          <router-link to="/blog" class="text-base text-gray-500 hover:text-gray-900">
            Blog
          </router-link>
        </div>
        <div class="px-5 py-2">
          <router-link to="/pricing" class="text-base text-gray-500 hover:text-gray-900">
            Pricing
          </router-link>
        </div>
        <div class="px-5 py-2">
          <router-link to="/templates" class="text-base text-gray-500 hover:text-gray-900">
            Templates
          </router-link>
        </div>
        <div class="px-5 py-2">
        ...
        <div class="px-5 py-2">
          <router-link to="/privacy" class="text-base text-gray-500 hover:text-gray-900">
            Privacy
          </router-link>
        </div>
        <div class="px-5 py-2">
          <router-link to="/terms" class="text-base text-gray-500 hover:text-gray-900">
            Terms
          </router-link>
        </div>
      </nav>
